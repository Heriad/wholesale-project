...
export default {
  ...
  async create(req, res, next) {
    if (!req.body.name || !req.body.surname || !req.body.email || !req.body.password || !req.body.workType || !req.body.role) {
      return res.status(400).send({ message: 'Required data: name, surname, email, password, workType, role' });
    }
    let newEmployee = createEmployee(req.body.name, req.body.surname, req.body.email, 
      req.body.password, req.body.workType, req.body.role);
  ...
  async update(req, res, next) {
    if (!req.body.id || !req.body.rev || !req.body.name || !req.body.surname || !req.body.email || !req.body.password || !req.body.workType || !req.body.role) {
      return res.status(400).send({ message: 'Required data: id, rev, name, surname, email, password, workType, role' });
    }
